...
if (isset($_SESSION['rec-form']) && $id == $dadosUser['id']) {
        ...
        <div class="container p-3">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
                ...
                <div class="mb-2 col-md-4 has-validation">
                    <p>Agora para darmos continuidade, informe o token e o login enviado para seu email e defina sua nova senha.
                    </p>
                    <label for="exampleInputEmail1" class="form-label">Login</label>
                    <input type="text" name="login" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Digite seu e-mail aqui!" required>
                </div>
                ...
                <div class="mb-2 col-md-4 has-validation">
                    ...
                    <input type="password" name="senhaNova" class="form-control" id="exampleInputPassword1" placeholder="Digite sua nova senha aqui..." required>
                </div>
                <div class="text-danger">
                    <?php echo $erros['senha']; ?>
                </div>
                <div class="mb-2 col-md-4 has-validation">
                    <label for="exampleInputPassword1" class="form-label">Reconfirme sua senha</label>
                    <input type="password" name="senhaRec" class="form-control" id="exampleInputPassword1" placeholder="Reescreva sua senha aqui..." required>
                </div>
                <div class="text-danger">
                    <?php echo $erros['senha']; ?>
                </div>
